...
process_substring = '"coat* machine" OR "physical vapor depostion" OR "physical vapour depostion" OR "pvd" OR "chemical vapor depostion" OR "chemical vapour depostion" OR "CVD" OR "sputter*" OR "evaporation" OR "ebeam" AND -disease'
